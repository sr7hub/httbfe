...
Sr7 script["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
Sr7 script["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

Sr7 script["2"] = Instance.new("Frame", Sr7 script["1"]);
Sr7 script["2"]["BorderSizePixel"] = 0;
Sr7 script["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
Sr7 script["2"]["Size"] = UDim2.new(0, 50, 0, 50);
Sr7 script["2"]["Draggable"] = true
Sr7 script["2"]["Position"] = UDim2.new(0.20, 0, -0.1, 0);
Sr7 script["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


Sr7 script["3"] = Instance.new("UICorner", Sr7 script["2"]);
Sr7 script["3"]["CornerRadius"] = UDim.new(1, 0);

Sr7 script["4"] = Instance.new("TextButton", Sr7 script["2"]);
Sr7 script["4"]["TextWrapped"] = true;
Sr7 script["4"]["BorderSizePixel"] = 0;
Sr7 script["4"]["TextSize"] = 14;
Sr7 script["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
Sr7 script["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
Sr7 script["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
Sr7 script["4"]["Size"] = UDim2.new(0, 50, 0, 56);
Sr7 script["4"]["BackgroundTransparency"] = 1;
Sr7 script["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
Sr7 script["4"]["Text"] = [[STOP TWEEN]];
Sr7 script["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
Sr7 script["5"] = Instance.new("UIStroke", Sr7 script["4"]);
Sr7 script["5"]["Color"] = Color3.fromRGB(255, 0, 0);

Sr7 script["6"] = Instance.new("UIStroke", Sr7 script["2"]);
Sr7 script["6"]["Color"] = Color3.fromRGB(169, 238, 8);
...
Sr7 script["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
